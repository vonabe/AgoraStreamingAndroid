package ru.vonabe.audiostreaming.only.ui;
...
import ru.vonabe.audiostreaming.only.model.AGEventHandler;
import ru.vonabe.audiostreaming.only.model.ConstantApp;
...
//    private final static Logger log = LoggerFactory.getLogger(LiveRoomActivity.class);
    ...
    public void onSwitchSpeakerClicked(View view) {
        Log.d(TAG, "onSwitchSpeakerClicked " + view + " " + mAudioMuted + " " + mAudioRouting);
    ...
    public void onEndCallClicked(View view) {
        Log.d(TAG, "onEndCallClicked " + view);
    ...
    private void doSwitchToBroadcaster(boolean broadcaster) {
        ...
        Log.d(TAG, "doSwitchToBroadcaster " + (uid & 0XFFFFFFFFL) + " " + broadcaster);
    ...
    public void notifyHeadsetPlugged(final int routing) {
        Log.d(TAG, "notifyHeadsetPlugged " + routing);
