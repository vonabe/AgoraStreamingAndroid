...
public class WorkerThread extends Thread {
    ...
    private static final String TAG = "WorkerThread2";
    ...
    private static final class WorkerThreadHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (this.mWorkerThread == null) {
                Log.d(TAG, "handler is already released! " + msg.what);
                return;
            }
    ...
    public final void joinChannel(final String channel, int uid) {
        ...
        ensureRtcEngineReadyLock();
        mRtcEngine.joinChannel(mContext.getString(R.string.my_token_channel), channel, "OpenVCall", uid);
    ...
    public final void configEngine(int cRole) {
        if (Thread.currentThread() != this) {
            Log.d(TAG, "configEngine() - worker thread asynchronously " + cRole);
            Message envelop = new Message();
